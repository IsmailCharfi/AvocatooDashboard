...
import {Row, Col, Card, Input, Button, Modal, Label, ModalHeader, ModalBody} from "reactstrap"
...
const AdminList = () => {
  ...
  const CustomHeader = ({ setSearch, search, setTake, take }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        await sendRequest(`${API_PATH}/auth/register/admin`, "POST", JSON.stringify(user))
        setModal(false)
